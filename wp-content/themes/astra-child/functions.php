...
function gnn_enqueue_styles() {
  ...
  wp_enqueue_style( 'front', get_stylesheet_directory_uri() . '/assets/css/front.css', array('slickcss', 'slickthemecss', 'bootstrap', 'gloss'));
  wp_enqueue_style( 'aboutpage', get_stylesheet_directory_uri() . '/assets/css/about.css', array('slickcss', 'slickthemecss', 'bootstrap', 'gloss'));
  wp_enqueue_style( 'news', get_stylesheet_directory_uri() . '/assets/css/news.css', array('slickcss', 'slickthemecss', 'bootstrap', 'gloss'));
  wp_enqueue_style( 'recipes', get_stylesheet_directory_uri() . '/assets/css/recipes.css', array('slickcss', 'slickthemecss', 'bootstrap', 'gloss'));
}
